...
const LArea = function () {
  var e = function () {
    this.gearArea, this.data=province.data, this.index = 0, this.value = [0, 0, 0]
  };
  return e.prototype = {
    init: function (e) {
      ...
      this.keys = e.keys, this.type = e.type || 1, this.type) { case 1: ; case 2: break; default: throw new Error("错误提示: 没有这种数据源类型") }
      this.bindEvent()
    },
    getData: function (e) {
      var t = this;
        ...
        a.open("get", t.params.data),
          a.onload = function (r) {
            if (a.status >= 200 && a.status < 300 || 0 === a.status) {
              var i = JSON.parse(a.responseText); t.data = i.data, e && e()
            }
          }, a.send()
      }
    }
    ...
    bindEvent: function () {
      function e(e) {
        d.gearArea = document.createElement("div"),
          ...
          t(); var n = d.gearArea.querySelector(".larea_cancel");
        n.addEventListener("touchstart", function (e) { d.close(e) });
        var s = d.gearArea.querySelector(".larea_finish");
        s.addEventListener("touchstart",
          function (e) { d.finish(e) });
